...
in  upstream
  with react-basic-classic =
    { dependencies =
       [ "react-basic", "aff" ] : List Text
    , repo =
       "https://github.com/lumihq/purescript-react-basic-classic"
    , version =
        "main"
    }
  with parsing-alphanumeric =
    { dependencies =
       [ ] : List Text
    , repo =
  ...
  with react-basic-dom =
    { dependencies =
       [ "foreign-object" ] : List Text
    , repo =
       "https://github.com/lumihq/purescript-react-basic-dom"
    , version =
        "v6.0.0"
    }
  with react-icons =
